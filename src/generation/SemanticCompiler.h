...
public:
    static std::unordered_map<int, int> compile(std::vector<SemanticEdge>& edges, void *heatmap = nullptr) {
        ...
        storage.push_back(SemanticRelations{});
        int WallZ = storage.size() - 1;
        relationsByVertex[WallZ] = WallZ;
        storage.push_back(SemanticRelations{});
        int diagonalZ = storage.size() - 1;
        relationsByVertex[diagonalZ] = diagonalZ;
        storage.push_back(SemanticRelations{});
        ...
        edges.push_back(SemanticEdge{ pillarB, floorPillarTypes, RelativeTransform{ 51.0f, 3.141592f/2.0f, 0.0f } });
        storage[pillarB].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ pillarC, floorPillarTypes, RelativeTransform{ 72.83f, -3.141592f/4.0f, 0.0f } });
        storage[pillarC].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ WallA, floorPillarTypes, RelativeTransform{ 51.83f, -3.141592f/4.0f, 0.0f } });
        int pilA = edges.size();
        ...
        edges.push_back(SemanticEdge{ pillarE, floorPillarTypes, RelativeTransform{ 51.0f, 3.141592f/2.0f, 0.0f } });
        storage[pillarE].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ pillarF, floorPillarTypes, RelativeTransform{ 72.83f, -3.141592f/4.0f, 0.0f } });
        storage[pillarF].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ WallB, floorPillarTypes, RelativeTransform{ 51.83f, -3.141592f/4.0f, 0.0f } });
        ...
        edges.push_back(SemanticEdge{ pillarH, floorPillarTypes, RelativeTransform{ 51.83f, 3.141592f/2.0f, 0.0f } });
        storage[pillarH].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ pillarI, floorPillarTypes, RelativeTransform{ 72.83, -3.141592f/4.0f, 0.0f } });
        storage[pillarI].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ WallC, floorPillarTypes, RelativeTransform{ 51.83f, -3.141592f/4.0f, 0.0f } });
        ...
        edges.push_back(SemanticEdge{ pillarK, floorPillarTypes, RelativeTransform{ 51.83f, 3.141592f/2.0f, 0.0f } });
        storage[pillarK].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ pillarL, floorPillarTypes, RelativeTransform{ 72.83f, -3.141592f/4.0f, 0.0f } });
        storage[pillarL].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ WallF, floorPillarTypes, RelativeTransform{ 51.83f, -3.141592f/4.0f, 0.0f } });
        ...
        edges.push_back(SemanticEdge{ pillarN, floorPillarTypes, RelativeTransform{ 51.83f, 3.141592f/2.0f, 0.0f } });
        storage[pillarN].addEdge(edges.size(), 1);
        edges.push_back(SemanticEdge{ pillarO, floorPillarTypes, RelativeTransform{ 72.83f, -3.141592f/4.0f, 0.0f } });
