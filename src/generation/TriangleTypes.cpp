...
TriangleTypeRegistry::registerType(TriangleFaceType::InsideWallFirstFloor,
    ...
    TriangleTypeRegistry::registerType(TriangleFaceType::InsideRoofFirstFloor,
    [](std::vector<int>& neighbours) {
        buildFlatGeometry(neighbours, SURFACE_DEFAULT, inside_09008000);
    });

    TriangleTypeRegistry::registerType(TriangleFaceType::InsideWallWood,
    [](std::vector<int>& neighbours) {
        buildFlatGeometry(neighbours, SURFACE_DEFAULT, inside_09003800);
    });

    TriangleTypeRegistry::registerType(TriangleFaceType::InsideWallBricks,
    [](std::vector<int>& neighbours) {
